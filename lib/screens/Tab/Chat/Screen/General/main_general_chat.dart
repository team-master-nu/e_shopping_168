...
class main_general_chat extends StatefulWidget {
  const main_general_chat({super.key});

  @override
  State<main_general_chat> createState() => _main_gemeralState();
}

class _main_gemeralState extends State<main_general_chat> {
  @override
