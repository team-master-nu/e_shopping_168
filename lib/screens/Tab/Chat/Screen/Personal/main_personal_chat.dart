...
class main_personal_chat extends StatefulWidget {
  const main_personal_chat({super.key});

  @override
  State<main_personal_chat> createState() => _main_gemeralState();
}

class _main_gemeralState extends State<main_personal_chat> {
  @override
